...
public class MiddleSaleListJob implements BaseJob {
    private static final Logger log = LoggerFactory.getLogger(MiddleSaleListJob.class);
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        String url=AccessToken.interfaceUrl+"/compInterface/saleList/addSale";
        try {
        ...
        log.info("发票清单上传任务执行的时间：" + dateFormat.format(new Date()));
    }
